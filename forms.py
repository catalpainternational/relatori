...
from catalpa.simple_locations.models import FacilityType, Facility
...
class CumulativeForm(forms.Form):
    ...
    #facility = Facility.objects.filter(pk=models.Settings.objects.all()[0].facility.pk)
...
class SummaryReportForm(forms.Form):
    ...
    #    facility = Facility.objects.filter(pk=facility[0].parent.pk)
